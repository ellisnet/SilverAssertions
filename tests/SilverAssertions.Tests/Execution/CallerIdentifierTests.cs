...
{
    public class CallerIdentifierTests
    {
        [Fact]
        ...
        //NOTE: This test asserts on the caller name that CallerIdentifier recovers by walking
        //  the stack. JIT inlining in an optimized (Release) build can remove that frame. The
        //  tests that actually break this way guard with Assert.SkipWhen(JitOptimization...).
        [Fact]
        ...
        public void All_core_code_anywhere_in_the_stack_trace_is_ignored()
        {
            ...
            /*
             We want to test this specific scenario.
                ...
                2. SilverAssertions code
                3. Custom extension <--- pointed to by lastUserStackFrameBeforeSilverAssertionsCodeIndex
                4. SilverAssertions code  <--- this is where DetermineCallerIdentity tried to get the variable name from before the fix
                5. Test
             */
