...
namespace SilverAssertions.Tests.Streams;
...
public class StreamAssertionTests
{
    ...
    public class HavePosition
    {
        ...
        [Theory]
        [MemberData(nameof(GetPositionExceptions), MemberType = typeof(StreamAssertionTests))]
    ...
    public class HaveLength
    {
        ...
        [Theory]
        [MemberData(nameof(GetLengthExceptions), MemberType = typeof(StreamAssertionTests))]
