...
{
    /// <summary>
    /// Defines the key for the configuration of the test framework to be assumed in SilverAssertions.
    /// </summary>
    private const string TestFrameworkConfigurationKey = "SilverAssertions.TestFramework";
