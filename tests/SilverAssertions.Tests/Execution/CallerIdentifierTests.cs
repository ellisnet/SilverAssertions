...
namespace SilverAssertions.Tests.Execution
{
    public class CallerIdentifierTests
    {
        ...
        //NOTE: This test relies on CallerIdentifier reading source file info from the stack trace (PDB);
        //  it will likely fail in Release configuration. Run in Debug configuration.
        [Fact]
