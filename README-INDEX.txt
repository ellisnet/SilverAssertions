...
------------------------------------------------------------------
  AGENT-README.txt
      SilverAssertions.ApacheLicenseForever — fluent assertions for .NET unit
      tests: the .Should() API, object-graph equivalency, exceptions and async,
      types and members, events, and the extensibility points.
