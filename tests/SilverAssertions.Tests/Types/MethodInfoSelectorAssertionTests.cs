...
namespace SilverAssertions.Tests.Types;

public class MethodInfoSelectorAssertionTests
{
            ...
            When_asserting_methods_are_virtual_but_non_virtual_methods_are_found_it_should_throw_with_descriptive_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected methods" +
                    ...
                    "Void SilverAssertions*ClassWithNonVirtualPublicMethods.PublicDoNothing*" +
                    "Void SilverAssertions*ClassWithNonVirtualPublicMethods.InternalDoNothing*" +
                    "Void SilverAssertions*ClassWithNonVirtualPublicMethods.ProtectedDoNothing");
        }
    }
            ...
            When_asserting_methods_are_decorated_with_attribute_but_they_are_not_it_should_throw_with_descriptive_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected methods to be decorated with" +
                    " SilverAssertions*DummyMethodAttribute because we want to test the error message," +
                    " but the following methods are not:*" +
                    "Void SilverAssertions*ClassWithMethodsThatAreNotDecoratedWithDummyAttribute.PublicDoNothing*" +
                    "Void SilverAssertions*ClassWithMethodsThatAreNotDecoratedWithDummyAttribute.ProtectedDoNothing*" +
                    "Void SilverAssertions*ClassWithMethodsThatAreNotDecoratedWithDummyAttribute.PrivateDoNothing");
        }
    }
        ...
        public void When_not_all_methods_have_specified_accessor_it_should_throw()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected methods to be Public" +
                    ", but the following methods are not:*" +
                    "Void SilverAssertions*ClassWithNonPublicMethods.PublicDoNothing*" +
                    "Void SilverAssertions*ClassWithNonPublicMethods.DoNothingWithParameter*" +
                    "Void SilverAssertions*ClassWithNonPublicMethods.DoNothingWithAnotherParameter");
        }
        ...
        public void When_any_method_have_specified_accessor_it_should_throw()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected methods to not be Public" +
                    ...
                    "Void SilverAssertions*ClassWithPublicMethods.PublicDoNothing*");
        }
        ...
        public void When_asserting_methods_are_async_but_non_async_methods_are_found_it_should_throw_with_descriptive_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected methods" +
                    ...
                    "Task SilverAssertions.Tests.Types.ClassWithNonAsyncMethods.PublicDoNothing" + Environment.NewLine +
                    "Task SilverAssertions.Tests.Types.ClassWithNonAsyncMethods.InternalDoNothing" + Environment.NewLine +
                    "Task SilverAssertions.Tests.Types.ClassWithNonAsyncMethods.ProtectedDoNothing");
        }
    }
        ...
        public void When_asserting_methods_are_not_async_but_async_methods_are_found_it_should_throw_with_descriptive_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected methods" +
                    ...
                    "Task SilverAssertions.Tests.Types.ClassWithAllMethodsAsync.PublicAsyncDoNothing" + Environment.NewLine +
                    "Task SilverAssertions.Tests.Types.ClassWithAllMethodsAsync.InternalAsyncDoNothing" + Environment.NewLine +
                    "Task SilverAssertions.Tests.Types.ClassWithAllMethodsAsync.ProtectedAsyncDoNothing");
        }
    }
}
