...
namespace SilverAssertions.Equivalency.Tests;
...
public class DictionaryTests
{
        ...
        When_asserting_equivalence_of_generic_dictionaries_the_type_information_should_be_preserved_for_other_equivalency_steps()
    {
        ...
        var dictionary1 = new Dictionary<Guid, IEnumerable<string>> { [userId] = new List<string> { "Admin", "Testial" } };
        ...
        When_asserting_equivalence_of_non_generic_dictionaries_the_lack_of_type_information_should_be_preserved_for_other_equivalency_steps()
    {
        ...
        var dictionary1 = new NonGenericDictionary { [userId] = new List<string> { "Admin", "Testial" } };
        ...
        When_the_dictionary_values_are_handled_by_the_enumerable_equivalency_step_the_type_information_should_be_preserved()
    {
        ...
        actual.Add(userId, "Admin", "Testial");
        ...
        // Assert
        act.Should().Throw<XunitException>()
            .WithMessage("Expected*Roles[*][1]*Other*Testial*");
    }
        ...
        When_subject_dictionary_with_class_keys_asserted_to_be_equivalent_and_other_dictionary_derived_class_keys_fails_because_of_types_incompatibility()
    {
        ...
        action.Should().Throw<XunitException>()
            .WithMessage(
                "Expected dictionary2 to be a dictionary or collection of key-value pairs that is keyed to type SilverAssertions.Equivalency.Tests.DictionaryTests+SomeBaseKeyClass.*");
    }
    ...
    public void Custom_types_which_implementing_dictionaries_pass()
    {
        ...
        var expected = new Tests.NonGenericDictionary
        {
            ["id"] = 22,
            ["CustomerId"] = 33
        };
    ...
    {
        var subject = new Tests.NonGenericDictionary
        {
            ["id"] = 22,
            ["CustomerId"] = 33
        };
