...
namespace SilverAssertions.Tests.Collections;

/// <content>
/// The Satisfy specs.
/// </content>
public partial class CollectionAssertionTests
{
...
*(element == 3)");
            ...
            When_assertion_fails_then_failure_message_must_contain_predicates_without_matching_elements_and_elements_without_matching_predicates()
        {
            ...
            act.Should().Throw<XunitException>().WithMessage(
                ...
                *Index: 0, Element:*SilverAssertions.Tests.Collections.CollectionAssertionTests+SomeClass*{*Number = 1*Text = "one"*}
                *Index: 1, Element:*SilverAssertions.Tests.Collections.CollectionAssertionTests+SomeClass*{*Number = 3*Text = "two"*}
                *Index: 2, Element:*SilverAssertions.Tests.Collections.CollectionAssertionTests+SomeClass*{*Number = 3*Text = "three"*}
                """);
        }
