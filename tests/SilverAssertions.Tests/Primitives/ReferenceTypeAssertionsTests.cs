...
public class ReferenceTypeAssertionsTests
{
    ...
    public void When_a_derived_class_has_longer_formatting_than_the_base_class()
    {
        ...
        act.Should().Throw<XunitException>()
            ...
            {
                SilverAssertions.Tests.Primitives.Complex
                {
                    Statement = "goodbye"
                }
            }.
    ...
    public void When_an_assertion_on_two_objects_fails_it_should_show_the_properties_of_the_class()
    {
        ...
        // Assert
        act.Should().Throw<XunitException>().WithMessage(
            "Expected subject to be*SilverAssertions*SomeDto*{*Age = 2*Birthdate = <2009-02-22>*" +
            "  Name = \"Teddie\"*}, but found*SilverAssertions*SomeDto*{*Age = 37*" +
