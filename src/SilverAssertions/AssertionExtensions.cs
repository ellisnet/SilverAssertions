...
using SilverAssertions.Reflection;
using SilverAssertions.Specialized;
using SilverAssertions.Streams;
using SilverAssertions.Types;
using SilverAssertions.Xml;
using JetBrains.Annotations;
using SilverAssertions.Events;
...
public static class AssertionExtensions
{
    ...
    /// current <see cref="SilverAssertions.Specialized.ExecutionTime"/>.
    /// </summary>
    [Pure]
    ...
    /// <summary>
    /// Returns a <see cref="SilverAssertions.Types.MethodBaseAssertions{TSubject, TAssertions}"/> object
