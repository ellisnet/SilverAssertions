...
public class PropertyInfoAssertionTests
{
    public class BeVirtual
    {
        ...
        public void When_asserting_that_a_property_is_virtual_and_it_is_not_then_it_fails_with_useful_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage(
                    "Expected property String SilverAssertions*ClassWithNonVirtualPublicProperties.PublicNonVirtualProperty" +
    ...
    public class BeDecortatedWithOfT
    {
        ...
        public void When_asserting_a_property_is_decorated_with_attribute_and_it_is_not_it_throw_with_useful_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected property String " +
                    "SilverAssertions*ClassWithPropertiesThatAreNotDecoratedWithDummyAttribute.PublicProperty to be decorated with " +
                    "SilverAssertions*DummyPropertyAttribute because we want to test the error message, but that attribute was not found.");
        }
            ...
            When_asserting_a_property_is_decorated_with_an_attribute_matching_a_predicate_but_it_is_not_it_throw_with_useful_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage(
                    "Expected property String SilverAssertions*ClassWithPropertiesThatAreNotDecoratedWithDummyAttribute.PublicProperty to be decorated with " +
