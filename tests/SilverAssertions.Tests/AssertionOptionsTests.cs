using DennisDoomen.ChillBdd;
using SilverAssertions.Equivalency;
using SilverAssertions.Equivalency.Steps;
...
public class AssertionOptionsTests
{
    ...
    [CollectionDefinition("AssertionOptionsTests", DisableParallelization = true)]
    public class AssertionOptionsTestsDefinition;
    ...
    [Collection("AssertionOptionsTests")]
