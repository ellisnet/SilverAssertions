...
using DennisDoomen.ChillBdd.StateBuilders;
...
namespace DennisDoomen.ChillBdd.Tests
{
    public class GivenWhenThenTests : GivenWhenThen
    {
        ...
        //TODO: Figure out how to fix the following test, in light of how the AutofacChillContainer works with the latest version of Autofac
        /*
        [Fact]
        ...
        */
        ...
        public void When_later_no_exception_would_be_thrown_but_caught_exception_is_used_it_should_throw()
        {
            ...
            a.Should().Throw<InvalidOperationException>().WithMessage("Expected exception but no exception was thrown");
        }
        ...
        public class Given_several_testclasses_in_the_container : GivenWhenThen
        {
            ...
            //TODO: Figure out how to fix the following tests, in light of how the AutofacChillContainer works with the latest version of Autofac
            /*
            [Fact]
