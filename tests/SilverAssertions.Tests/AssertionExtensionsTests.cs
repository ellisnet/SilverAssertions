...
public class AssertionExtensionsTests
{
    ...
    {
        // Arrange / Act
        var equalsOverloads = AllTypes.From(typeof(SilverAssertions.AssertionExtensions).Assembly)
            .ThatAreClasses()
    ...
    {
        // Arrange
        MethodInfo fakeOverload = AllTypes.From(typeof(SilverAssertions.AssertionExtensions).Assembly)
            .ThatAreClasses()
            .ThatAreStatic()
            .Where(t => t.IsPublic)
    ...
    {
        // Arrange / Act
        List<MethodInfo> shouldOverloads = AllTypes.From(typeof(SilverAssertions.AssertionExtensions).Assembly)
            .ThatAreClasses()
            .ThatAreStatic()
            .Where(t => t.IsPublic)
            .SelectMany(t => t.GetMethods(BindingFlags.Static | BindingFlags.Public))
