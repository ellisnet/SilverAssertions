...
using SilverAssertions.Equivalency.Execution;
...
[Collection(nameof(StringComparisonTests))]
...
[CollectionDefinition(nameof(StringComparisonTests), DisableParallelization = true)]
