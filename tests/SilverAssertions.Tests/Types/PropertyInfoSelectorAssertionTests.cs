...
public class PropertyInfoSelectorAssertionTests
{
            ...
            When_asserting_properties_are_virtual_but_non_virtual_properties_are_found_it_should_throw_with_descriptive_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected properties" +
                    ...
                    "String SilverAssertions*ClassWithNonVirtualPublicProperties.PublicNonVirtualProperty*" +
                    "String SilverAssertions*ClassWithNonVirtualPublicProperties.InternalNonVirtualProperty*" +
                    "String SilverAssertions*ClassWithNonVirtualPublicProperties.ProtectedNonVirtualProperty");
        }
    }
            ...
            When_asserting_properties_are_decorated_with_attribute_and_they_are_not_it_should_throw_with_descriptive_message()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage("Expected all selected properties to be decorated with" +
                    " SilverAssertions*DummyPropertyAttribute because we want to test the error message," +
                    " but the following properties are not:*" +
                    "String SilverAssertions*ClassWithPropertiesThatAreNotDecoratedWithDummyAttribute.PublicProperty*" +
                    "String SilverAssertions*ClassWithPropertiesThatAreNotDecoratedWithDummyAttribute.InternalProperty*" +
                    "String SilverAssertions*ClassWithPropertiesThatAreNotDecoratedWithDummyAttribute.ProtectedProperty");
        }
    }
        ...
        public void When_a_read_only_property_is_expected_to_be_writable_it_should_throw_with_descriptive_message()
        {
            ...
            action
                ...
                .WithMessage(
                    ...
                    "String SilverAssertions*ClassWithReadOnlyProperties.ReadOnlyProperty*" +
                    "String SilverAssertions*ClassWithReadOnlyProperties.ReadOnlyProperty2");
        }
        ...
        public void When_a_writable_property_is_expected_to_be_read_only_it_should_throw_with_descriptive_message()
        {
            ...
            action
                ...
                .WithMessage(
                    ...
                    "String SilverAssertions*ClassWithWritableProperties.ReadWriteProperty*" +
                    "String SilverAssertions*ClassWithWritableProperties.ReadWriteProperty2");
        }
