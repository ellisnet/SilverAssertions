...
using TypeEnumerableExtensionsTests.BaseNamespace;
using TypeEnumerableExtensionsTests.BaseNamespace.Nested;
using TypeEnumerableExtensionsTests.Internal;
using Xunit;

namespace SilverAssertions.Tests
{
    public class TypeEnumerableExtensionsTests
    {
        [Fact]
...
namespace TypeEnumerableExtensionsTests.BaseNamespace
{
    internal class BaseNamespaceClass;
}

namespace TypeEnumerableExtensionsTests.BaseNamespace.Nested
{
    internal class NestedNamespaceClass;
}

namespace TypeEnumerableExtensionsTests.Internal
{
