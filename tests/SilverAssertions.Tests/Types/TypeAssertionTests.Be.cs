...
/// The [Not]Be specs.
/// </content>
public partial class TypeAssertionTests
{
    public class Be
    {
        [Fact]
...
#pragma warning restore 436
            ...
            act.Should().Throw<XunitException>()
                .WithMessage(
                    "Expected type to be [TestAssemblyB.ClassC, TestAssemblyB*] *failure message*, but found [TestAssemblyB.ClassC, SilverAssertions.Tests*].");
        }
        */
