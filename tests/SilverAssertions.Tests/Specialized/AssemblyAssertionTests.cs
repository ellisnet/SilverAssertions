...
using TestAssemblyA;
using TestAssemblyB;
using SilverAssertions.Tests.Types;
using Xunit;
using Xunit.Sdk;
...
public class AssemblyAssertionTests
{
    public class NotReference
    {
        ...
        public void When_subject_is_null_not_reference_should_fail()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage(
                    "Expected assembly not to reference assembly \"TestAssemblyB\" *failure message*, but assemblyA is <null>.");
        }
    ...
    public class Reference
    {
        ...
        public void When_subject_is_null_reference_should_fail()
        {
            ...
            act.Should().Throw<XunitException>()
                .WithMessage(
                    "Expected assembly to reference assembly \"TestAssemblyB\" *failure message*, but assemblyA is <null>.");
        }
