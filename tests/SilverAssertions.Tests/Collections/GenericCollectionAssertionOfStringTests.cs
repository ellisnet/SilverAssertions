...
/// </summary>
public partial class GenericCollectionAssertionOfStringTests
{
    [Fact]
    ...
    public void When_collection_contains_multiple_matches_which_should_throw()
    {
        ...
        // Assert
        action.Should().Throw<XunitException>()
            .WithMessage("More than one object found.  SilverAssertions cannot determine which object is meant.*")
