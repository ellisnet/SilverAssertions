...
public class PredicateLambdaExpressionValueFormatterTests
{
    ...
    public void When_condition_contains_linq_extension_method_then_extension_method_must_be_formatted()
    {
        ...
        // Assert
        //Was previously: result.Should().Be("value(System.Int32[]).Contains(a)");
        result.Should().Be("op_Implicit(value(System.Int32[])).Contains(a)");
    }
