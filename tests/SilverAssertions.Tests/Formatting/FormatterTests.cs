...
using SilverAssertions.Tests.Common;
using Xunit;
using Xunit.Sdk;

namespace SilverAssertions.Tests.Formatting;

[Collection("FormatterTests")]
public class FormatterTests
{
    ...
    public void When_the_object_is_a_generic_type_without_custom_string_representation_it_should_show_the_properties()
    {
        ...
        act.Should().Throw<XunitException>()
            ...
            {
                SilverAssertions.Tests.Formatting.FormatterTests+Stuff`1[[System.Int32*]]
                {
                    Children = {1, 2, 3, 4}, 
                    Description = "Stuff_1", 
                    StuffId = 1
    ...
    public void When_the_object_is_a_user_defined_type_it_should_show_the_name_on_the_initial_line()
    {
        ...
        act.Should().Throw<XunitException>()
            ...
            """
            Expected stuff to be <null>, but found SilverAssertions.Tests.Formatting.FormatterTests+StuffRecord
            {
                RecordChildren = {10, 20, 30, 40}, 
                RecordDescription = "description", 
                RecordId = 42, 
                SingleChild = SilverAssertions.Tests.Formatting.FormatterTests+ChildRecord
                {
                    ChildRecordId = 24
                }
            }.
    ...
    public void When_the_object_is_a_record_it_should_show_the_properties_recursively()
    {
        ...
        act.Should().Throw<XunitException>()
            ...
            {
                RecordDescription = "WRONG_DESCRIPTION"
            }, but found SilverAssertions.Tests.Formatting.FormatterTests+StuffRecord
            {
        ...
        When_formatting_multiple_items_with_a_custom_string_representation_using_line_breaks_it_should_end_lines_with_a_comma()
    {
        ...
        // Assert
        result.Should().Contain($"SilverAssertions.Tests.Formatting.FormatterTests+A, {Environment.NewLine}");
        result.Should().Contain($"SilverAssertions.Tests.Formatting.FormatterTests+B{Environment.NewLine}");
    }
...
#pragma warning restore 169, CA1823, IDE0044, RCS1169
    ...
    {
        // Arrange
        Configuration.Current.ValueFormatterAssembly = "SilverAssertions";
    ...
    public void When_defining_a_custom_enumerable_value_formatter_it_should_respect_the_overrides()
    {
        ...
        str.Should().Match(Environment.NewLine +
            "{*SilverAssertions*FormatterTests+CustomClass" + Environment.NewLine +
            "    {" + Environment.NewLine +
...
[CollectionDefinition("FormatterTests", DisableParallelization = true)]
public class FormatterTestsDefinition;
